...
;to make-landscape_1_scenarios
          ;if landscape_1_scenarios = "fragmented-segregated" [
            ;set plant-number 160 / 16  ; same amount of plants in every local area
            ;Here I want to randomly assign the 16 colors=plants, one color to each local area
            ;set pcolor according to csv file!!!!
            ; set pcolor green ;region 1 (number-of-regions * number-of-regions)
            ; ]
            ; ]

          ;if landscape = "habitat-structured"[
            ;set
            ;here only plants can be inside certain habitats, i.e. squares mimicking habitats in the field
            ;use info from plant_paramter file
            ;]

          ;if landscape "heterogenously-mixed"[
             ; Here I wanted to randomly assign the 16 colors=plants to every local area
             ;]
;end
